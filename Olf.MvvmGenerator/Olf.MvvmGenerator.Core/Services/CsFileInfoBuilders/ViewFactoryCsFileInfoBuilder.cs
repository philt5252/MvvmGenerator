...
{
    public class ViewFactoryCsFileInfoBuilder : CsFileInfoBuilder<ParsedCommandWithProperties>
    {
        private readonly CsFileInfo viewFactoryInterfaceCsFileInfo;

        public ViewFactoryCsFileInfoBuilder(ParsedCommandWithProperties parsedCommand, IVisualStudioIde visualStudioIde,
